% This function computes whre the Gamme Knife x-ray will go through the
% person's skin. This function creates a line from the isocenter (tumor)
% and the point on the helmet determined by the longitude and latitude of
% source and radius of Gamma Knife. It then finds the intersection of this
% line and the head, defined as an ellipsoid with 3 axis, A, B, and C. It
% then determines which of the (probable) 2 intersection points is closer
% to the source, and uses that as the skins entry point.
%
...
%		  Radius of Gamme Knife Helmet (radius)
