function [y] = Compute_Linear_Function (P1, P2, x)
	...
	if (P1 == P2)
		% If x value is the same as points return y, else y cannot be found
		if (x == P1(1))
			y = P1(2);
			return;
		else
	...
	% b is the y - intercept. Find where the line intercepts the y axis.
	Point1 = [P1(1), P1(2), 0];
	Point2 = [P2(1), P2(2), 0];
	b = Q2A1(Point1, Point2, [0,0,0], [0,1,0]);
	
	% take the y value of found y intercept
	b = b(2);
	mx = m.*x;
